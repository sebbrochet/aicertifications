...
#
# Palette "Microsoft AI / Copilot": deep blue + cyan accent + gold, aligned with the
# MkDocs theme (blue/cyan) and mermaid-config.json.
#
...
# --- Background: 3-stop vertical gradient (deep blue) ---
$rect = New-Object System.Drawing.Rectangle 0, 0, $W, $H
$lgb  = New-Object System.Drawing.Drawing2D.LinearGradientBrush($rect, (C '#0b3d91'), (C '#050c22'), [System.Drawing.Drawing2D.LinearGradientMode]::Vertical)
$blend = New-Object System.Drawing.Drawing2D.ColorBlend 3
$blend.Colors    = @((C '#0b3d91'), (C '#123a7a'), (C '#050c22'))
$blend.Positions = @(0.0, 0.42, 1.0)
$lgb.InterpolationColors = $blend
$g.FillRectangle($lgb, $rect)

# --- Bright halo at the top (cyan) ---
$gp = New-Object System.Drawing.Drawing2D.GraphicsPath
$gp.AddEllipse(150, -560, 1300, 1300)
$pgb = New-Object System.Drawing.Drawing2D.PathGradientBrush($gp)
$pgb.CenterColor = (A 85 (C '#38bdf8'))
$pgb.SurroundColors = @((A 0 (C '#38bdf8')))
$g.FillPath($pgb, $gp)
...
$brCyan  = New-Object System.Drawing.SolidBrush $cyan
...
# --- Overline ---
$fOver = Font 30 $semi
Draw-Tracked "MICROSOFT AI CERTIFICATIONS   •   2026 EDITION" $fOver $brGold $mLeft 250 6

# --- Title (two lines) ---
$fT1 = Font 200 $bold
$g.DrawString("COPILOT", $fT1, $brWhite, ($mLeft - 12), 460)
$fT2 = Font 96 $bold
$g.DrawString("TO TRANSFORMATION", $fT2, $brCyan, ($mLeft - 6), 700)

# --- Gold rule ---
$g.FillRectangle($brGold, $mLeft, 840, 240, 9)

# --- Subtitle (wrapped) ---
$fSub = Font 47 $reg
$sfSub = New-Object System.Drawing.StringFormat
$subRect = New-Object System.Drawing.RectangleF $mLeft, 910, 1080, 320
$subtitle = "The complete guide to Microsoft's AI business certifications: from Copilot user to AI transformation leader — AB-730 & AB-731."
$g.DrawString($subtitle, $fSub, $brLight, $subRect, $sfSub)

# --- Exam / domain lines ---
$fDom = Font 32 $semi
Draw-Tracked "EXAM AB-730  /  EXAM AB-731" $fDom $brMuted $mLeft 1440 4
Draw-Tracked "COPILOT  /  FOUNDRY  /  GOVERNANCE  /  ADOPTION" $fDom $brMuted $mLeft 1500 4

# --- Network motif (AI as connected nodes) ---
$nodes = @(
...
$penNet = New-Object System.Drawing.Pen((A 90 $cyan), 2.5)
foreach ($e in $edges) {
...
for ($i = 0; $i -lt $nodes.Count; $i++) {
    $n = $nodes[$i]; $r = $radii[$i]
    $g.FillEllipse($brCyan, [single]($n[0]-$r), [single]($n[1]-$r), [single]($r*2), [single]($r*2))
}
...
$g.DrawString("18 chapters`n+ mock exams", $fEd, $brGold, $edRect, $sfR)
