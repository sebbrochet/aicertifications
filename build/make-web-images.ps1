...
#   - cover-web.png : ~600 px-wide thumbnail for the Introduction page (web only)
#   - og-cover.png  : 1200 x 630 social/Open Graph preview (top-anchored crop, keeps the title)
#
# Downscale / crop ONLY — the master cover.png is never modified. Run this whenever the master
...
# Background: vertical gradient matching the cover palette (deep blue -> near-black)
...
$bg = New-Object System.Drawing.Drawing2D.LinearGradientBrush($bgRect,
    ...
    [System.Drawing.ColorTranslator]::FromHtml('#050c22'),
...
$cyanBr = New-Object System.Drawing.SolidBrush([System.Drawing.ColorTranslator]::FromHtml('#38bdf8'))
$whiteBr = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::White)
$lightBr = New-Object System.Drawing.SolidBrush([System.Drawing.ColorTranslator]::FromHtml('#dceafc'))
...
$g2.DrawString('MICROSOFT AI CERTIFICATION STUDY GUIDE', $fEyebrow, $cyanBr, (New-Object System.Drawing.RectangleF $tx, 90, $twCol, 34))
$g2.DrawString('Copilot to Transformation', $fTitle, $whiteBr, (New-Object System.Drawing.RectangleF $tx, 132, $twCol, 200))
$g2.DrawString("The complete guide to Microsoft's AI business certifications", $fSub, $lightBr, (New-Object System.Drawing.RectangleF $tx, 350, $twCol, 90))
$g2.DrawString("AB-730  $dot  AB-731", $fBadge, $goldBr, (New-Object System.Drawing.RectangleF $tx, 455, $twCol, 46))
